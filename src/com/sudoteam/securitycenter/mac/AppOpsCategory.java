...
import com.sudoteam.securitycenter.mac.AppOpsState.AppOpEntry;
...
public class AppOpsCategory extends ListFragment implements LoaderCallbacks<List<AppOpEntry>> {
	private static final String TAG = "AppOpsCategory";
    ...
    public AppOpsCategory(AppOpsState.OpsTemplate template, String packageName) {
    ...
    @Override public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        if (entry != null) {
            ...
            startApplicationDetailsActivity(mCurrentPkgName);
        }
        
        Toast.makeText(getActivity(), "You Touched: "+this.getClass().getName(), 5).show();
    }
    
    private void startApplicationDetailsActivity(String packName){
        Bundle args = new Bundle();
    ...
    @Override
	public android.support.v4.content.Loader<List<AppOpEntry>> onCreateLoader(int id, Bundle args) {
        ...
        return new AppListLoader(getActivity(), mState, template, packageName);
    }

	@Override
	public void onLoadFinished(android.support.v4.content.Loader<List<AppOpEntry>> loader,List<AppOpEntry> data) {
	...
	@Override
	public void onLoaderReset(android.support.v4.content.Loader<List<AppOpEntry>> loader) {
    ...
    public static class AppListLoader extends AsyncTaskLoader<List<AppOpEntry>> {
        ...
        public AppListLoader(Context context, AppOpsState state, AppOpsState.OpsTemplate template, String packName) {
            super(context);
            mState = state;
            mTemplate = template;
            pName = packName;
        ...
        @Override public List<AppOpEntry> loadInBackground() {
        	if(pName == null)
        		...
        		return mState.buildState(mTemplate, 0, pName);
        }
    ...
    public static class AppListAdapter extends BaseAdapter {
        ...
        @Override public View getView(int position, View convertView, ViewGroup parent) {
            ...
            imageView.setImageDrawable(item.getAppEntry().getIcon());
