...
public class AppOpsDetails extends Fragment {
    ...
    private Bundle pakName = null;    
    public AppOpsDetails(Bundle pakName){
    ...
    private boolean refreshUi() {
        ...
        for (AppOpsState.OpsTemplate tpl : AppOpsState.ALL_TEMPLATES) {
            ...
            Log.i(TAG, "===============entries.size() = " + entries.size());
    ...
    private void prepareCustomPreferencesList(ViewGroup parent, View child, View list, boolean ignoreSidePadding) {
