...
public class DeviceBaseController {
    ...
    public static boolean setAirPlanModeEnabled(Context context, boolean enabled) {
        ...
        boolean bool = Settings.Global.putInt(context.getContentResolver(),
    ...
    public static void setMobileDataEnabled(Context context, boolean enabled) {
        ...
        // android 5.0 move this API to TelephonyManager
    ...
    public static int getLockedScreenTimeout(Context context) {
        long currentTimeout = Settings.System.getLong(context.getContentResolver(),
                SCREEN_OFF_TIMEOUT,
    ...
    public static void setVirateWhenRinging(Context context, boolean enabled) {
        Settings.System.putInt(context.getContentResolver(), Settings.System.VIBRATE_WHEN_RINGING,
                enabled ? 1 : 0);
    }
