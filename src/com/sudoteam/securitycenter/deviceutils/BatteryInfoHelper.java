...
public class BatteryInfoHelper {
	...
	public void registerBatteryChangeReceiver(Context context) {
		IntentFilter batteryChange_filter = new IntentFilter(
	...
	public int getDefaultAcChargeSurplusTime() {
		int defaultAcChargeSumTime = ConvertHelper
				.hour2Second(DEFAULT_BATTERY_CAPACITY / DEFAULT_AC_CHARGEING);
	...
	public int getDefaultUsbChargeSurplusTime() {
		int defaultUsbChargeSumTime = ConvertHelper
				.hour2Second(DEFAULT_BATTERY_CAPACITY / DEFAULT_USB_CHARGEING);
		float batteryPer = 1 - getBatterySurplusPercent();
	...
	public static class BatteryInfoReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			Intent batteryServiceIntent = new Intent(context,
					PowerComputeService.class);
			batteryServiceIntent.putExtra(BATTERY_STATUS,
					sBatteryInfo.batteryStatus);
			batteryServiceIntent.putExtra(BATTERY_LEVEL,
					sBatteryInfo.batteryLevel);
			batteryServiceIntent.putExtra(BATTERY_PLUGGED,
					sBatteryInfo.batteryPlugged);
